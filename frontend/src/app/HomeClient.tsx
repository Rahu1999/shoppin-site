...
import { ArrowRight, ShieldCheck, Package, Clock, Sparkles, Phone, Mail, MapPin, CheckCircle, MessageSquare } from 'lucide-react';
...
export default function HomeClient({ displayProducts }: { displayProducts: HomeProduct[] }) {
