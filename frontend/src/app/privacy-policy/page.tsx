...
export const metadata: Metadata = {
  title: 'Privacy Policy — Rajesh Industries',
  description: 'Privacy Policy for Rajesh Industries (steelkitchen.in). Learn how we collect, use, and protect your personal data.',
};
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="container mx-auto px-4 lg:px-8 py-12 max-w-4xl">
        ...
        <div className="mb-10">
          <h1 className="text-3xl font-black text-gray-900 tracking-tight mb-2">Privacy Policy</h1>
        ...
        <div className="prose prose-slate max-w-none text-gray-700 space-y-6 leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-8">Collecting and Using Your Personal Data</h2>
          <h3 className="text-lg font-semibold text-gray-800">Types of Data Collected</h3>
          <h4 className="font-semibold text-gray-800">Personal Data</h4>
          <p>
          ...
          <h4 className="font-semibold text-gray-800">Tracking Technologies and Cookies</h4>
          <p>
          ...
          <h3 className="text-lg font-semibold text-gray-800">Use of Your Personal Data</h3>
          ...
          <h3 className="text-lg font-semibold text-gray-800">Retention of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold text-gray-800">Transfer of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold text-gray-800">Delete Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold text-gray-800">Disclosure of Your Personal Data</h3>
          <h4 className="font-semibold text-gray-800">Business Transactions</h4>
          <p>
            If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
          </p>
          <h4 className="font-semibold text-gray-800">Law enforcement</h4>
          <p>
            Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
          </p>
          <h4 className="font-semibold text-gray-800">Other legal requirements</h4>
          ...
          <h3 className="text-lg font-semibold text-gray-800">Security of Your Personal Data</h3>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-8">Changes to this Privacy Policy</h2>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              ...
              <Link href="/privacy-policy" className="text-blue-600 hover:underline">
                https://steelkitchen.in/privacy-policy
              </Link>
            </li>
            <li>
              By phone:{' '}
