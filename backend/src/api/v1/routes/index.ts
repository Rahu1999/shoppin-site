...
import catalogueEnquiriesRoutes from '@modules/catalogue-enquiries/catalogue-enquiries.routes';
import catalogueItemsRoutes from '@modules/catalogue-items/catalogue-items.routes';
...
router.use('/catalogue-enquiries', catalogueEnquiriesRoutes);
router.use('/catalogue-items', catalogueItemsRoutes);
router.use('/module-settings', moduleSettingsRoutes);
